...
// docs/layer3-formula-retrieval-plan.md). Structural-lexical canonical form: a formula
// collapses to single-space-joined tokens; braces/brackets/parens are structural and
// removed; case is preserved. Unicode maps, MAX_FORMULA_CHARS and the protected-segment
// scanner are reused from L1 math-text.ts (imports only, never duplicated).
